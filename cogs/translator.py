...
class Translator(commands.Cog):
	...
	async def on_raw_reaction_add(self,payload):
		...
		for i in range(len(flags)):
			if(emoji == flags[i]):
				...
				alsoTranslate = 'Translation:\n\n'
				
				translated = translator.translate_text(toTranslate, target_lang=lang)
				alsoTranslated =  translator.translate_text(alsoTranslate, target_lang=lang)
				
				translated = f'{alsoTranslated}{translated}'
	...
	async def private_translate(self,ctx, private:discord.Option(bool)):
